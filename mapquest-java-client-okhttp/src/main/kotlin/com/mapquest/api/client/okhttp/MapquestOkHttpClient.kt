...
import com.mapquest.api.client.MapquestClientImpl
...
/**
 * A class that allows building an instance of [MapquestClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class MapquestOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [MapquestClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): MapquestClient = builder().fromEnv().build()
    }

    /** A builder for [MapquestOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [MapquestClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MapquestClient =
            MapquestClientImpl(
                clientOptions
                    .httpClient(
