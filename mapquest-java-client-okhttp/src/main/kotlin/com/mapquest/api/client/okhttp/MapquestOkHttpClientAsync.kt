...
package com.mapquest.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.mapquest.api.client.MapquestClientAsync
import com.mapquest.api.client.MapquestClientAsyncImpl
import com.mapquest.api.core.ClientOptions
import com.mapquest.api.core.Sleeper
import com.mapquest.api.core.Timeout
import com.mapquest.api.core.http.Headers
import com.mapquest.api.core.http.HttpClient
import com.mapquest.api.core.http.QueryParams
import com.mapquest.api.core.jsonMapper
...
/**
 * A class that allows building an instance of [MapquestClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class MapquestOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [MapquestClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): MapquestClientAsync = builder().fromEnv().build()
    }

    /** A builder for [MapquestOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.mapquest.api.core.jsonMapper]. The default is usually sufficient and
        ...
        /**
         * Returns an immutable instance of [MapquestClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MapquestClientAsync =
            MapquestClientAsyncImpl(
                clientOptions
                    .httpClient(
