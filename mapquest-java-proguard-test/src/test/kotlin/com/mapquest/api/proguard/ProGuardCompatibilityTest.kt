...
package com.mapquest.api.proguard
...
internal class ProGuardCompatibilityTest {
    ...
    fun proguardRules() {
        val rulesFile =
            javaClass.classLoader.getResourceAsStream("META-INF/proguard/mapquest-java-core.pro")
    ...
    @Test
    fun client() {
        val client = MapquestOkHttpClient.builder().apiKey("My API Key").build()
