...
dependencies {
    testImplementation(project(":mapquest-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../mapquest-java-core/src/main/resources/META-INF/proguard/mapquest-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.mapquest.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../mapquest-java-core/src/main/resources/META-INF/proguard/mapquest-java-core.pro",
