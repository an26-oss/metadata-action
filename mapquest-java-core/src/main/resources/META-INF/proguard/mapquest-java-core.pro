...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.mapquest.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.mapquest.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.mapquest.api.** {
    <init>(...);
