...
/**
 * A client for interacting with the Mapquest REST API asynchronously. You can also switch to
...
interface MapquestClientAsync {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): MapquestClientAsync
    ...
    /**
     * A view of [MapquestClientAsync] that provides access to raw HTTP responses for each method.
     */
