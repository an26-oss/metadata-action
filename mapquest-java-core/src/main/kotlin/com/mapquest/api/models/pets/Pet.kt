...
package com.mapquest.api.models.pets

import com.fasterxml.jackson.annotation.JsonAnyGetter
import com.fasterxml.jackson.annotation.JsonAnySetter
import com.fasterxml.jackson.annotation.JsonCreator
import com.fasterxml.jackson.annotation.JsonProperty
import com.mapquest.api.core.Enum
import com.mapquest.api.core.ExcludeMissing
import com.mapquest.api.core.JsonField
import com.mapquest.api.core.JsonMissing
import com.mapquest.api.core.JsonValue
import com.mapquest.api.core.checkKnown
import com.mapquest.api.core.checkRequired
import com.mapquest.api.core.toImmutable
...
private constructor(
    ...
    /**
     * @throws MapquestInvalidDataException if the JSON field has an unexpected type or is
    ...
    /**
     * @throws MapquestInvalidDataException if the JSON field has an unexpected type (e.g. if the
    ...
    fun isValid(): Boolean =
        try {
            validate()
            true
        } catch (e: MapquestInvalidDataException) {
            false
        }
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
         ...
         *
         * @throws MapquestInvalidDataException if this class instance's value is a not a known
         *   member.
         */
        fun known(): Known =
            when (this) {
                ...
                SOLD -> Known.SOLD
                else -> throw MapquestInvalidDataException("Unknown Status: $value")
            }
         ...
         *
         * @throws MapquestInvalidDataException if this class instance's value does not have the
         *   expected primitive type.
         */
        fun asString(): String =
            _value().asString().orElseThrow {
                MapquestInvalidDataException("Value is not a String")
            }
    ...
    private constructor(
        ...
        /**
         * @throws MapquestInvalidDataException if the JSON field has an unexpected type (e.g. if
