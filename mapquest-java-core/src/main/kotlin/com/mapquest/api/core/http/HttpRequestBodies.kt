...
import com.mapquest.api.core.MultipartField
    ...
    object : HttpRequestBody {
        ...
        private fun serializePart(
            ...
            when (node.nodeType) {
                            ...
                            node
                                ...
                                .mapNotNull { element ->
                                    when (element.nodeType) {
                                        ...
                                        JsonNodeType.OBJECT,
                                        JsonNodeType.POJO ->
                                            throw MapquestInvalidDataException(
                ...
                JsonNodeType.POJO,
                null ->
                    throw MapquestInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
            }
